...
const items = [
  {
    ...
    description:
      "We believe that real change begins at the grassroots level. Our primary focus is on empowering communities by providing them with the necessary tools and resources to make informed decisions. Through workshops, training sessions, and resource-sharing, we encourage community engagement and active participation in projects that directly impact their lives. By fostering a sense of ownership, we help individuals and groups to become change-makers in their own right.",
  },
  {
